  ...
  return (
    <main className="px-4 md:px-8 lg:px-12 py-10">
      <div className="max-w-md mx-auto space-y-4">
        <h1 className="text-2xl font-semibold text-[var(--fg)]">Войти</h1>
        <form className="space-y-3">
          ...
          <button type="submit" className="w-full rounded-full bg-[var(--accent)] text-black font-semibold px-4 py-2">Войти</button>
        </form>
        <p className="text-sm text-[var(--fg)]/70">Нет аккаунта? <a href="/register" className="text-[var(--accent)]">Зарегистрироваться</a></p>
      </div>
    </main>
  );
}
